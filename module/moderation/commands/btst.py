...
def setup(bot: commands.Bot):
    ...
    # async def tabs_choice(interaction: commands.Interaction):
    ...
    # @bot.listen('on_button_click')
    # async def settings_choice(interaction: commands.Interaction):
    #     try:
    ...
    @bot.listen('on_button_click')
    async def settings(interaction: commands.Interaction):
    ...
    # async def second_set(interaction: commands.Interaction):
    #     try:
    #         old_emb = interaction.message.embeds[0]
    #
